...
* [nb](https://github.com/xwmx/nb) ⭐ 8,366 | 🐛 150 | 🌐 Shell | 📅 2026-08-20
* [Dendron](https://github.com/dendronhq/dendron) ⭐ 7,461 | 🐛 800 | 🌐 TypeScript | 📅 2025-11-13
* [Athens](https://github.com/athensresearch/athens) ⭐ 6,299 | 🐛 316 | 🌐 Clojure | 📅 2023-02-03
* [zk](https://github.com/zk-org/zk) ⭐ 2,770 | 🐛 25 | 🌐 Go | 📅 2026-08-03. Plain-text Zettelkasten on the command line, with native LSP support and editor integrations for Neovim, Emacs, and VSCode.
* [IWE](https://github.com/iwe-org/iwe) ⭐ 1,562 | 🐛 3 | 🌐 Rust | 📅 2026-08-15
...
* [vim-zettel](https://github.com/michal-h21/vim-zettel) ⭐ 589 | 🐛 54 | 🌐 Vim Script | 📅 2025-11-19
...
* [zk-reindex-launchd](https://github.com/johntrandall/zk-reindex-launchd) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2026-04-30. macOS LaunchAgent that auto-reindexes [zk](https://github.com/zk-org/zk) ⭐ 2,770 | 🐛 25 | 🌐 Go | 📅 2026-08-03 notebooks on a schedule. Set-and-forget — keeps queries (CLI, LSP, MCP) current after edits made outside an LSP-aware editor.
